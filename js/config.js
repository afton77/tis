...
function config($stateProvider, $urlRouterProvider, $ocLazyLoadProvider, IdleProvider, KeepaliveProvider) {
  ...
  $stateProvider
    ...
    .state('kpa.perbaikan_alat', {
      url: "/perbaikan_alat",
      templateUrl: "views/perbaikan_alat.html",
      data: {pageTitle: 'Perbaikan Alat'},
      resolve: {
        loadPlugin: function ($ocLazyLoad) {
          return $ocLazyLoad.load([
            {
    ...
    .state('kpa.daftar_perbaikan_alat', {
      url: "/daftar_perbaikan_alat",
      templateUrl: "views/daftar_perbaikan_alat.html",
      data: {pageTitle: 'Daftar Perbaikan Alat'},
      resolve: {
        loadPlugin: function ($ocLazyLoad) {
          return $ocLazyLoad.load([
            {
    ...
    .state('kpa.perbaikan_alat_planner', {
      url: "/perbaikan_alat_planner",
      templateUrl: "views/perbaikan_alat_planner.html",
      data: {pageTitle: 'Maintenance Planner'},
      resolve: {
        loadPlugin: function ($ocLazyLoad) {
          return $ocLazyLoad.load([
            {
    ...
    .state('kpa.perbaikan_alat_operation', {
      url: "/perbaikan_alat_operation",
      templateUrl: "views/perbaikan_alat_operation.html",
      data: {pageTitle: 'Maintenance Operation'},
      resolve: {
        loadPlugin: function ($ocLazyLoad) {
          return $ocLazyLoad.load([
            {
    ...
    .state('kpa.perbaikan_alat_daftar_mp', {
      url: "/perbaikan_alat_daftar_mp",
      templateUrl: "views/perbaikan_alat_daftar_mp.html",
      data: {pageTitle: 'Daftar Maintenance Planner'},
      resolve: {
        loadPlugin: function ($ocLazyLoad) {
          return $ocLazyLoad.load([
            {
